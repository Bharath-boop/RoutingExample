         ...
         <div className="card-body">
             <div className="row no-gutters align-items-center">
                 <div className="col mr-2">
                     <div className="text-xs font-weight-bold text-info text-uppercase mb-1">{data.title}
                     </div>
                     <div className="row no-gutters align-items-center">
                         ...
                         <div className="col">
                             <div className="progress progress-sm mr-2">
                                 <div className={`progress-bar bg-${data.color}`}role="progressbar"
                                     style={{width:`${data.value}%`,ariaValueNow:`${data.value}`,ariaValueMin:"0",
                                     ariaValueMax:"100"}}>
                                     </div>
                             </div>
                         </div>
